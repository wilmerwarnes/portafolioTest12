...
`;let Ji=null,fl=null,pl=null,Hr=null;function cx(){const i=ax(rx,qi),e=i.slice(),t=new Float32Array(qi);for(let s=0;s<qi;s++)t[s]=Math.random();const n=new zt,r=new Pt(e,3);return r.setUsage(xf),n.setAttribute("position",r),n.setAttribute("aSeed",new Pt(t,1)),Hr=new rn({vertexShader:ox,fragmentShader:lx,transparent:!0,depthWrite:!1,blending:Fr,uniforms:{uTime:{value:0},uPixelRatio:{value:Math.min(window.devicePixelRatio,2)},uSize:{value:sx},uColorCore:{value:new Ce(16777215)},uColorEdge:{value:new Ce(65535)}}}),Ji=new Ch(n,Hr),Ji.raycast=()=>{},fl=i,pl=new Float32Array(qi*3),Ji}const ux="assets/models/mi-logo.glb",hx=4.5;function dx(i,e){i.updateMatrixWorld(!0);const t=[];let n=0;const r=new R,s=new R,o=new R,a=new R,l=new R;i.traverse(u=>{if(!u.isMesh)return;const f=(u.geometry.index?u.geometry.toNonIndexed():u.geometry).getAttribute("position"),m=Math.floor(f.count/3);if(m===0)return;const _=new Float32Array(m);let g=0;for(let d=0;d<m;d++)r.fromBufferAttribute(f,d*3).applyMatrix4(u.matrixWorld),s.fromBufferAttribute(f,d*3+1).applyMatrix4(u.matrixWorld),o.fromBufferAttribute(f,d*3+2).applyMatrix4(u.matrixWorld),a.subVectors(s,r),l.subVectors(o,r),g+=a.cross(l).length()*.5,_[d]=g;g>0&&(n+=g,t.push({pos:f,matrix:u.matrixWorld.clone(),areas:_,triCount:m,cumulative:n}))});const c=new Float32Array(e*3);if(t.length===0||n===0)return c;for(let u=0;u<e;u++){const h=Math.random()*n;let f=t[t.length-1];for(let v=0;v<t.length;v++)if(h<=t[v].cumulative){f=t[v];break}const m=Math.random()*f.areas[f.triCount-1];let _=0,g=f.triCount-1;for(;_<g;){const v=_+g>>1;f.areas[v]<m?_=v+1:g=v}r.fromBufferAttribute(f.pos,_*3).applyMatrix4(f.matrix),s.fromBufferAttribute(f.pos,_*3+1).applyMatrix4(f.matrix),o.fromBufferAttribute(f.pos,_*3+2).applyMatrix4(f.matrix);let d=Math.random(),p=Math.random();d+p>1&&(d=1-d,p=1-p);const E=1-d-p;c[u*3]=r.x*E+s.x*d+o.x*p,c[u*3+1]=r.y*E+s.y*d+o.y*p,c[u*3+2]=r.z*E+s.z*d+o.z*p}return c}function fx(i,e){let t=1/0,n=1/0,r=1/0,s=-1/0,o=-1/0,a=-1/0;for(let m=0;m<i.length;m+=3)t=Math.min(t,i[m]),s=Math.max(s,i[m]),n=Math.min(n,i[m+1]),o=Math.max(o,i[m+1]),r=Math.min(r,i[m+2]),a=Math.max(a,i[m+2]);const l=(t+s)/2,c=(n+o)/2,u=(r+a)/2,h=Math.max(s-t,o-n,a-r,1e-4),f=e/h;for(let m=0;m<i.length;m+=3)i[m]=(i[m]-l)*f,i[m+1]=(i[m+1]-c)*f,i[m+2]=(i[m+2]-u)*f}function px(i){fl=i;const e=Ji.geometry.getAttribute("position");e.array.set(i),e.needsUpdate=!0,pl.fill(0)}async function mx(i){const t=(await _d(()=>import("./GLTFLoader-BDdBxa9R.js"),[])).GLTFLoader;new t().load(i,r=>{const s=dx(r.scene,qi);fx(s,hx),px(s)},void 0,r=>{console.warn("No se pudo cargar el .glb de particulas, se mantiene la figura de prueba:",r)})}const wu=new kn,Cu=new R,zs=new R,Ru=new R,Lu=new R;function gx(i,e){if(!Ji)return;const t=Ji.geometry.getAttribute("position"),n=t.array,r=fl,s=pl;let o=!1;sn&&Rt===0&&!Xe()&&(et.getWorldDirection(Ru),Ln.getWorldPosition(Lu),wu.setFromNormalAndCoplanarPoint(Ru,Lu),Yi.setFromCamera(qr,et),Yi.ray.intersectPlane(wu,Cu)&&(Ln.worldToLocal(zs.copy(Cu)),o=!0));const a=Math.exp(-6*i),l=xo*xo;for(let c=0;c<qi;c++){const u=c*3,h=u+1,f=u+2;let m=s[u],_=s[h],g=s[f];if(o){const d=n[u]-zs.x,p=n[h]-zs.y,E=n[f]-zs.z,v=d*d+p*p+E*E;if(v<l&&v>1e-4){const T=Math.sqrt(v),L=d/T,A=p/T,w=E/T,H=1-T/xo,M=H*H*i,b=-A,z=L,q=0;m+=(L+b*Mo)*yo*M,_+=(A+z*Mo)*yo*M,g+=(w+q*Mo)*yo*M}}m+=(r[u]-n[u])*So*i,_+=(r[h]-n[h])*So*i,g+=(r[f]-n[f])*So*i,m*=a,_*=a,g*=a,n[u]+=m*i,n[h]+=_*i,n[f]+=g*i,s[u]=m,s[h]=_,s[f]=g}t.needsUpdate=!0,Hr.uniforms.uTime.value=e}const Gh=-2.75,Vh=2.75,sr=1,_x=1,Ws=.0092,vx=1.95,xx=-.55,yx=.68,Mx=.0078,Ln=new Gn;Ln.position.set(Vh,sr,0);Ln.add(cx());st.add(Ln);mx(ux);let Wo=sr,Xo=sr;function Wh(){const i=pn[kt];return`
    ...
    `,n.style.cursor="pointer",n.addEventListener("click",c=>{if(c.stopPropagation(),Xe()){const u=Dt.findIndex(h=>h.key===i.key);if(u!==pr){Sa(u);return}}ad(i.key),Ut("open")});const r=n.querySelectorAll(".pc-img"),s=t.projects.map(c=>c.img);let o=1%s.length;const a=setInterval(()=>{const c=n.querySelector(".pc-img.pc-active"),u=c===r[0]?r[1]:r[0];u.src=s[o],requestAnimationFrame(()=>{u.classList.add("pc-active"),c.classList.remove("pc-active")}),o=(o+1)%s.length},Nx),l={catSpec:i,el:n,intervalId:a};return Zh.push(l),n}function Ox(){const i=pn[kt];Zh.forEach(e=>{const t=e.el.querySelector(".pc-title");t&&(t.innerHTML=`${i[e.catSpec.titleKey]}<span class="pc-sub">${i[e.catSpec.subKey]}</span>`)})}const Fx=3.9,Bx=5.05,xl=new Gn,Ma={};Dt.forEach(i=>{const e=new jr({transparent:!0,opacity:0,depthWrite:!1,depthTest:!1}),t=new We(new $r(Fx,Bx),e);t.position.set(i.slot*ya,1,-42),t.userData={type:"project-card",key:i.key},t.raycast=We.prototype.raycast,xl.add(t),Ma[i.key]=t});st.add(xl);const oi={};Dt.forEach(i=>{const e=Jh(i),t=new Qr(e),n=$h();t.scale.set(n,n,n),t.position.set(i.slot*ya,1,-42),mi.add(t),oi[i.key]=t});Object.assign(window,{cssCardGroups:oi});function Nu(){Object.keys(oi).forEach(i=>{try{mi.remove(oi[i])}catch{}delete oi[i]}),Dt.forEach(i=>{const e=Jh(i),t=new Qr(e),n=$h();t.scale.set(n,n,n),t.position.set(i.slot*ya,1,-42),mi.add(t),oi[i.key]=t}),Object.assign(window,{cssCardGroups:oi})}function Qh(){const i=Dt.length,e=jh;Dt.forEach((t,n)=>{var f;let r=n-pr;r>i/2&&(r-=i),r<-i/2&&(r+=i);const s=Math.abs(r),o=r*Cx,l=e*(s===0?1:Rx),c=ih.clamp(-r*Lx,-Uu,Uu);vl[t.key]=c;const u=(f=window.cssCardGroups)==null?void 0:f[t.key];u&&(u.position.x=o,u.position.z=-42-s*.9,u.scale.set(l,l,l),u.element.classList.toggle("js-hover",s===0));const h=Ma[t.key];h&&(h.position.x=o)})}function Gr(){if(Xe()){Qh();return}Dt.forEach(e=>{var s;const t=e.slot*ya;vl[e.key]=0;const n=(s=window.cssCardGroups)==null?void 0:s[e.key];n&&(n.scale.set(qs,qs,qs),n.position.x=t,n.position.z=-42,n.element.classList.remove("js-hover"));const r=Ma[e.key];r&&(r.position.x=t)})}Gr();requestAnimationFrame(()=>{Gr()});function zx(i,e){if(Xe())return;const t=sn&&Rt===2&&!It;Dt.forEach(n=>{var l;const r=(l=window.cssCardGroups)==null?void 0:l[n.key];if(!r)return;const s=r.element;if(!t){s.classList.remove("js-hover");return}const o=s.getBoundingClientRect(),a=o.width>0&&i>=o.left&&i<=o.right&&e>=o.top&&e<=o.bottom;s.classList.toggle("js-hover",a)})}function ed(){Dt.forEach(i=>{var t;const e=(t=window.cssCardGroups)==null?void 0:t[i.key];e&&e.element.classList.remove("js-hover")})}const Bt=[{name:"inicio",objectZ:0,offset:7},{name:"perfil",objectZ:ml,offset:8},{name:"proyectos",objectZ:-42,offset:9},{name:"contacto",objectZ:gl,offset:8}],kx=1.4;function es(i){return i.offset*(Xe()?kx:1)}function td(){return Bt[0].objectZ+es(Bt[0])}function nd(){const i=Bt[Bt.length-1];return i.objectZ+es(i)}let An=Bt[0].objectZ+es(Bt[0]);const id=.08,rd=200;let qn=null;const Hx=-42,Gx=11,Vx=18,Ou=10,Fu=16,Wx=0,Xx=8,qx=14;function ks(i,e,t,n){const r=Math.abs(i-e);return r<=t?1:r>=n?0:1-(r-t)/(n-t)}const aa=-15,sd=-42,Yx=.0105,jx=3.5,$x=.0088,Kx=1.55,Bu=1.05,Zx=.42,Jx=.2,zu=3;let It=!1,Vr=null,Un=0,Dn=[],Eo=!1,Wr=!1;const ts=new Gn;ts.position.set(0,aa,sd);mi.add(ts);const Qx=3.4,ey=4.6,or=new Gn;or.position.set(0,aa,sd);st.add(or);let Xr=[];function ty(i){Xr.forEach(e=>or.remove(e)),Xr=i.map((e,t)=>{const n=new jr({transparent:!0,opacity:0,depthWrite:!1,depthTest:!1}),r=new We(new $r(Qx,ey),n);return r.userData={type:"gallery-card",index:t,projectId:e.id},r.raycast=We.prototype.raycast,or.add(r),r})}function ny(i,e){const t=document.createElement("div");t.className="gallery-card",t.innerHTML=`
        <div class="gc-inner">
    ...
    `,t.addEventListener("click",r=>{r.stopPropagation(),e===Un?al(Vr,i.id):vi(e)});const n=new Qr(t);return ts.add(n),{obj:n,el:t,project:i}}function yl(){const i=Xe(),e=i?Kx:jx,t=i?$x:Yx,n=Dn.length;Dn.forEach((r,s)=>{let o=s-Un;o>n/2&&(o-=n),o<-n/2&&(o+=n);const a=Math.abs(o),l=o*e,c=-a*1.5,u=ih.clamp(-o*Zx,-Bu,Bu),h=Math.max(.5,1-a*Jx);r.obj.position.set(l,0,c),r.obj.rotation.y=u,r.obj.scale.set(t*h,t*h,t*h);const f=Xr[s];f&&(f.position.set(l,0,c),f.rotation.y=u,f.visible=a<=zu);const m=a<=zu,_=m?Math.max(0,1-a*.28):0;r.el.style.opacity=_.toFixed(3),r.el.style.pointerEvents=m?"auto":"none",r.el.classList.toggle("gc-center",o===0)})}function iy(i,e){!It||Xe()||Dn.forEach(t=>{const n=t.el.getBoundingClientRect(),r=n.width>0&&i>=n.left&&i<=n.right&&e>=n.top&&e<=n.bottom;t.el.classList.toggle("js-hover",r)})}function ry(){Dn.forEach(i=>i.el.classList.remove("js-hover"))}function vi(i){const e=Dn.length;e!==0&&(Un=(i%e+e)%e,yl(),Ut("tick"))}window.goToGalleryIndex=vi;function sy(i){Vr=i,Un=0,Dn.forEach(n=>ts.remove(n.obj)),Dn=_t[i].projects.map((n,r)=>ny(n,r)),ty(_t[i].projects),yl(),It=!0;const e=document.getElementById("gallery-title"),t=document.getElementById("gallery-hud");e&&(e.innerText=Kh(i)),t==null||t.classList.add("active"),ns()}function Ml(){if(!It)return;It=!1;const i=document.getElementById("gallery-hud");i==null||i.classList.remove("active"),ry(),Dn.forEach(e=>ts.remove(e.obj)),Dn=[],Xr.forEach(e=>or.remove(e)),Xr=[],Ut("close"),ns()}window.closeGallery=Ml;const Hs=document.getElementById("gallery-prev"),Gs=document.getElementById("gallery-next");Hs&&(Hs.addEventListener("click",()=>vi(Un-1)),Hs.addEventListener("mouseenter",()=>{Wr=!0}),Hs.addEventListener("mouseleave",()=>{Wr=!1}));Gs&&(Gs.addEventListener("click",()=>vi(Un+1)),Gs.addEventListener("mouseenter",()=>{Wr=!0}),Gs.addEventListener("mouseleave",()=>{Wr=!1}));function ay(i){Eo||Math.abs(i.deltaY)<6||(Eo=!0,vi(Un+(i.deltaY>0?1:-1)),setTimeout(()=>{Eo=!1},260))}let Dr=null;window.addEventListener("touchstart",i=>{It&&(Dr=i.touches[0].clientX)},{passive:!0});window.addEventListener("touchend",i=>{if(!It||Dr===null)return;const e=i.changedTouches&&i.changedTouches[0]?i.changedTouches[0].clientX:Dr,t=Dr-e;Dr=null,!(Math.abs(t)<=40)&&vi(Un+(t>0?1:-1))},{passive:!0});function ad(i){sy(i)}function Sa(i){pr=(i%Dt.length+Dt.length)%Dt.length,Qh(),Ut("tick")}window.goToCategoryIndex=Sa;function ns(){const i=document.getElementById("cat-switch-nav");if(!i)return;const e=Xe()&&sn&&Rt===2&&!It;i.classList.toggle("active",e)}const ku=document.getElementById("cat-prev"),Hu=document.getElementById("cat-next");ku&&ku.addEventListener("click",()=>Sa(pr-1));Hu&&Hu.addEventListener("click",()=>Sa(pr+1));function od(i){i=Math.max(0,Math.min(Bt.length-1,i)),It&&Ml(),Rt=i;const e=Bt[i];An=e.objectZ+es(e),i!==2&&ed(),Ut("nav"),Fh(),hl(),ns(),Xe()&&i===2&&(requestAnimationFrame(()=>Gr()),setTimeout(()=>Gr(),100))}function ld(){let i=0,e=1/0;Bt.forEach((t,n)=>{const r=t.objectZ+es(t),s=Math.abs(An-r);s<e&&(e=s,i=n)}),od(i)}window.addEventListener("wheel",i=>{if(sn){if(It){ay(i);return}An+=i.deltaY*id,An=Math.max(nd(),Math.min(td(),An)),qn&&clearTimeout(qn),qn=setTimeout(ld,Xe()?120:rd)}});let Or=null;const oy=1.2;window.addEventListener("touchstart",i=>{sn&&(Or=i.touches[0].clientY)},{passive:!0});window.addEventListener("touchmove",i=>{if(!sn||Or===null||It)return;const e=i.touches[0].clientY,t=Or-e;Or=e,An+=-t*id*oy,An=Math.max(nd(),Math.min(td(),An)),qn&&clearTimeout(qn),qn=setTimeout(ld,Xe()?120:rd)},{passive:!0});window.addEventListener("touchend",()=>{Or=null});window.jumpToSection=Ih=function(i){sn&&(qn&&clearTimeout(qn),od(i))};let oa=0,la=0;const qr=new Te,Yi=new xv;window.addEventListener("pointermove",i=>{oa=i.clientX/window.innerWidth*2-1,la=-(i.clientY/window.innerHeight)*2+1,qr.x=oa,qr.y=la,ly(i.clientX,i.clientY),zx(i.clientX,i.clientY),iy(i.clientX,i.clientY)});function ly(i,e){if(!Pn.contact)return;const t=Pn.contact.element.querySelectorAll(".info-card-links a");if(Rt!==3){t.forEach(n=>n.classList.remove("js-hover"));return}t.forEach(n=>{const r=n.getBoundingClientRect(),s=r.width>0&&i>=r.left&&i<=r.right&&e>=r.top&&e<=r.bottom;n.classList.toggle("js-hover",s)})}function cy(i){if(Rt!==3||i.target.closest&&i.target.closest(".info-card-links"))return!1;const e=Pn.contact.element.querySelectorAll(".info-card-links a");for(const t of e){const n=t.getBoundingClientRect();if(!(n.width===0||n.height===0)&&i.clientX>=n.left&&i.clientX<=n.right&&i.clientY>=n.top&&i.clientY<=n.bottom){const r=t.getAttribute("href");if(!r)continue;return r.startsWith("mailto:")?window.location.href=r:t.getAttribute("target")==="_blank"?window.open(r,"_blank","noopener"):window.location.href=r,Ut("click"),!0}}return!1}window.addEventListener("click",i=>{if(!sn)return;if(It){if(!Pr||i.target!==Pr)return;Yi.setFromCamera(qr,et);const t=Yi.intersectObjects([or],!0);if(t.length>0){let n=t[0].object;for(;n.parent&&!n.userData.type;)n=n.parent;n.userData&&n.userData.type==="gallery-card"&&(n.userData.index===Un?al(Vr,n.userData.projectId):vi(n.userData.index))}return}if(cy(i)||!Pr||i.target!==Pr||Rt!==2)return;Yi.setFromCamera(qr,et);const e=Yi.intersectObjects([xl],!0);if(e.length>0){let t=e[0].object;for(;t.parent&&!t.userData.type;)t=t.parent;t.userData&&t.userData.type==="project-card"&&(ad(t.userData.key),Ut("open"))}});function uy(i){switch(i.type){case"text":return`<div class="case-block case-block-text"><p>${i.body}</p></div>`;case"image":return`<div class="case-block case-block-image"><img src="${i.src}" alt="" loading="lazy" draggable="false"></div>`;case"gif":return`<div class="case-block case-block-image case-block-gif"><span class="case-block-tag">GIF</span><img src="${i.src}" alt="" loading="lazy" draggable="false"></div>`;case"video":return`<div class="case-block case-block-video"><video src="${i.src}"${i.poster?` poster="${i.poster}"`:""} controls loop playsinline preload="metadata" muted></video></div>`;case"embed":return`<div class="case-block case-block-embed"><div style="padding:${i.ratio||"56.25%"} 0 0 0;position:relative;"><iframe src="${i.src}" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media" style="position:absolute;top:0;left:0;width:100%;height:100%;" allowfullscreen loading="lazy" title="Video"></iframe></div><script src="https://player.vimeo.com/api/player.js"><\/script></div>`;case"embed-txt":return`<div class="case-block case-block-embed" data-embed-txt="${(t=>t.replace(/"/g,"&quot;"))(i.src)}"><div style="padding:56.25% 0 0 0;position:relative;"><div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:#0a0a10;color:rgba(255,255,255,0.6);font-size:0.75rem;">Cargando video...</div></div></div>`;case"grid":return`<div class="case-block case-block-grid">${i.images.map(e=>`<img src="${e}" alt="" loading="lazy" draggable="false">`).join("")}</div>`;case"video-row":return`<div class="case-block case-block-video-row">${(i.items||[]).map(e=>e.type==="embed"?`<div class="video-row-item"><div style="padding:${e.ratio||"56.25%"} 0 0 0;position:relative;"><iframe src="${e.src}" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" style="position:absolute;top:0;left:0;width:100%;height:100%;" allowfullscreen loading="lazy"></iframe></div></div>`:e.type==="embed-txt"?`<div class="video-row-item" data-embed-txt="${e.src.replace(/"/g,"&quot;")}"><div style="padding:56.25% 0 0 0;position:relative;"><div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:#0a0a10;color:rgba(255,255,255,0.6);font-size:0.75rem;">Cargando video...</div></div></div>`:e.type==="video"?`<div class="video-row-item"><video src="${e.src}"${e.poster?` poster="${e.poster}"`:""} controls loop playsinline preload="metadata" muted></video></div>`:e.type==="image"?`<div class="video-row-item"><img src="${e.src}" alt="" loading="lazy"></div>`:"").join("")}</div>`;default:return""}}function hy(i,e){return`<div class="${e&&(e.layout==="tight"||e.name==="Tobey"||i.some(r=>r.type==="grid"||r.type==="video-row"||r.type==="embed-txt"))?"case-blocks case-blocks--tight":"case-blocks"}">${i.map(uy).join("")}</div>`}async function dy(i){const e=i.querySelectorAll("[data-embed-txt]");for(const t of Array.from(e)){const n=t.getAttribute("data-embed-txt");if(n)try{const r=await fetch(n);if(!r.ok)throw new Error(String(r.status));const s=await r.text();t.innerHTML=s,t.querySelectorAll("script").forEach(a=>{const l=document.createElement("script");a.src?l.src=a.src:l.textContent=a.textContent,document.head.appendChild(l)})}catch(r){console.warn("[embed-txt] fallo al cargar",n,r),t.innerHTML=`<div style="padding:16px;background:#1a1a1a;color:#fff;font-size:0.75rem;">No se pudo cargar el video: ${n}</div>`}}}let qt=null,ln=null;function fy(){ln||(ln=document.createElement("button"),ln.className="lightbox-close",ln.setAttribute("aria-label","Cerrar"),ln.innerHTML='<i class="fa-solid fa-xmark"></i>',ln.addEventListener("click",()=>_a()),document.body.appendChild(ln))}window.openLightbox=al=function(i,e){const t=_t[i].projects.find(o=>o.id===e);if(!t)return;qt||(qt=document.createElement("div"),qt.id="lightbox-overlay",qt.className="lightbox-overlay",document.body.appendChild(qt),qt.addEventListener("click",o=>{o.target===qt&&_a()})),fy();const n=t.blocks?hy(t.blocks,t):`<div class="lb-body"><p>${t.desc}</p></div><div class="lb-gallery">${t.gallery.map(o=>`<img src="${o}" alt="${t.name}" loading="lazy" draggable="false">`).join("")}</div>`,r=t.layout==="tight"||t.name==="Tobey"||t.blocks&&t.blocks.some(o=>o.type==="grid"||o.type==="video-row"||o.type==="embed-txt"),s=r?"":`
            <div class="lb-hero">
    ...
    `,dy(qt),qt.classList.add("open"),ln.classList.add("open"),Ut("open")};window.closeLightbox=_a=function(){qt&&qt.classList.remove("open"),ln&&ln.classList.remove("open"),Ut("close")};window.goToBrandHome=function(){Ml(),_a(),Ih(0)};const bo=document.getElementById("glow-slider");bo==null||bo.addEventListener("input",i=>{document.documentElement.style.setProperty("--card-glow",i.target.value)});window.addEventListener("resize",()=>{et.aspect=window.innerWidth/window.innerHeight,et.fov=Xe()?zh:Bh,et.updateProjectionMatrix(),_i.setSize(window.innerWidth,window.innerHeight),fi&&fi.setSize(window.innerWidth,window.innerHeight),xa.setSize(window.innerWidth,window.innerHeight),Hr&&(Hr.uniforms.uPixelRatio.value=Xe()?1:Math.min(window.devicePixelRatio,2)),Xh(),Gr(),Yh(),It&&yl(),ns(),Xe()&&ed(),hl(),st.background&&st.background.dispose&&st.background.dispose(),st.background=dl()});const Gu=new Ph;function cd(){requestAnimationFrame(cd);const i=Math.min(Gu.getDelta(),1/30),e=Gu.getElapsedTime();if(Xi&&(Xi.rotation.y=e*.006),sn){const t=Xe(),n=t?.09:.05;et.position.z+=(An-et.position.z)*n;const r=It;if(!_l){const f=r&&Wr;let m=0;f||(m=oa*(r?2.2:1.2)*(t?.7:1)),et.position.x+=(m-et.position.x)*n;const _=f?0:t||r?.15:.6,g=r?aa:2;et.position.y+=(g+la*_-et.position.y)*n}const s=r?aa:1;et.lookAt(et.position.x*.3,s,et.position.z-8),Ln.rotation.y=e*.35,gx(i,e),ar.position.y=Xo+Math.sin(e*.5)*.08;const o=ks(et.position.z,Wx,Xx,qx);fr.style.opacity=o.toFixed(3),Ln.position.y=Wo+Math.sin(e*.5)*.08,Dt.forEach((f,m)=>{var E;const g=(t?.55:1)+Math.sin(e*.6+m*2)*.12,d=(E=window.cssCardGroups)==null?void 0:E[f.key];if(d){d.position.y=g;const v=vl[f.key]||0;d.rotation.y=v+Math.sin(e*.35+m)*.05}const p=Ma[f.key];p&&(p.position.y=g)});const a=It?0:ks(et.position.z,Hx,Gx,Vx);Dt.forEach((f,m)=>{var d;const _=(d=window.cssCardGroups)==null?void 0:d[f.key];if(!_)return;let g=a;if(t){const p=Dt.length;let E=m-pr;E>p/2&&(E-=p),E<-p/2&&(E+=p),g=a*(E===0?1:Px)}_.element.style.opacity=g.toFixed(3),_.element.style.pointerEvents=g<.04?"none":"auto"});const l=ks(et.position.z,ml,Ou,Fu),c=ks(et.position.z,gl,Ou,Fu);Iu("about",l),Iu("contact",c);const u=Bt[Rt],h=Math.abs(et.position.z-u.objectZ);vo+=(h-vo)*Kv,sa&&(sa.uniforms.focus.value=vo)}fi?fi.render(i):_i.render(st,et),xa.render(mi,et)}cd();export{H0 as $,_y as A,Pt as B,Ce as C,lv as D,We as E,Ey as F,xy as G,Ah as H,vy as I,yy as J,Ch as K,Zr as L,My as M,wa as N,at as O,av as P,gi as Q,Ro as R,vt as S,py as T,Gn as U,Te as V,Ot as W,ih as X,Qo as Y,Th as Z,Sy as _,gy as a,js as a0,$s as a1,ta as a2,Et as a3,ia as a4,na as a5,Kr as a6,$e as a7,Yn as a8,ma as a9,$n as aa,In as ab,my as b,Ay as c,wn as d,Ty as e,He as f,R as g,ru as h,by as i,wy as j,B0 as k,Br as l,Qd as m,Nl as n,Nt as o,ht as p,Lo as q,en as r,wh as s,Kn as t,X0 as u,Fo as v,En as w,jr as x,je as y,zt as z};
