...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:dn,depthTest:!1,depthWrite:!1})}function kc(){return new an({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ol(),fragmentShader:`
		...
		`,blending:dn,depthTest:!1,depthWrite:!1})}function Hc(){return new an({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ol(),fragmentShader:`
...
`].filter(Yi).join(`
`)),o=Ho(o),o=Kc(o,t),o=Zc(o,t),a=Ho(a),a=Kc(a,t),a=Zc(a,t),o=Jc(o),a=Jc(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(v=`#version 300 es
...
`;let tr=null,yl=null,Ml=null,Yr=null;function gx(){const i=fx(hx,$i),e=i.slice(),t=new Float32Array($i);for(let s=0;s<$i;s++)t[s]=Math.random();const n=new Gt,r=new Nt(e,3);return r.setUsage(Tf),n.setAttribute("position",r),n.setAttribute("aSeed",new Nt(t,1)),Yr=new an({vertexShader:px,fragmentShader:mx,transparent:!0,depthWrite:!1,blending:Vr,uniforms:{uTime:{value:0},uPixelRatio:{value:Math.min(window.devicePixelRatio,2)},uSize:{value:dx},uColorCore:{value:new Ce(16777215)},uColorEdge:{value:new Ce(65535)}}}),tr=new Uh(n,Yr),tr.raycast=()=>{},yl=i,Ml=new Float32Array($i*3),tr}const _x="assets/models/mi-logo.glb",vx=4.5;function xx(i,e){i.updateMatrixWorld(!0);const t=[];let n=0;const r=new R,s=new R,o=new R,a=new R,l=new R;i.traverse(u=>{if(!u.isMesh)return;const f=(u.geometry.index?u.geometry.toNonIndexed():u.geometry).getAttribute("position"),m=Math.floor(f.count/3);if(m===0)return;const _=new Float32Array(m);let g=0;for(let d=0;d<m;d++)r.fromBufferAttribute(f,d*3).applyMatrix4(u.matrixWorld),s.fromBufferAttribute(f,d*3+1).applyMatrix4(u.matrixWorld),o.fromBufferAttribute(f,d*3+2).applyMatrix4(u.matrixWorld),a.subVectors(s,r),l.subVectors(o,r),g+=a.cross(l).length()*.5,_[d]=g;g>0&&(n+=g,t.push({pos:f,matrix:u.matrixWorld.clone(),areas:_,triCount:m,cumulative:n}))});const c=new Float32Array(e*3);if(t.length===0||n===0)return c;for(let u=0;u<e;u++){const h=Math.random()*n;let f=t[t.length-1];for(let v=0;v<t.length;v++)if(h<=t[v].cumulative){f=t[v];break}const m=Math.random()*f.areas[f.triCount-1];let _=0,g=f.triCount-1;for(;_<g;){const v=_+g>>1;f.areas[v]<m?_=v+1:g=v}r.fromBufferAttribute(f.pos,_*3).applyMatrix4(f.matrix),s.fromBufferAttribute(f.pos,_*3+1).applyMatrix4(f.matrix),o.fromBufferAttribute(f.pos,_*3+2).applyMatrix4(f.matrix);let d=Math.random(),p=Math.random();d+p>1&&(d=1-d,p=1-p);const E=1-d-p;c[u*3]=r.x*E+s.x*d+o.x*p,c[u*3+1]=r.y*E+s.y*d+o.y*p,c[u*3+2]=r.z*E+s.z*d+o.z*p}return c}function yx(i,e){let t=1/0,n=1/0,r=1/0,s=-1/0,o=-1/0,a=-1/0;for(let m=0;m<i.length;m+=3)t=Math.min(t,i[m]),s=Math.max(s,i[m]),n=Math.min(n,i[m+1]),o=Math.max(o,i[m+1]),r=Math.min(r,i[m+2]),a=Math.max(a,i[m+2]);const l=(t+s)/2,c=(n+o)/2,u=(r+a)/2,h=Math.max(s-t,o-n,a-r,1e-4),f=e/h;for(let m=0;m<i.length;m+=3)i[m]=(i[m]-l)*f,i[m+1]=(i[m+1]-c)*f,i[m+2]=(i[m+2]-u)*f}function Mx(i){yl=i;const e=tr.geometry.getAttribute("position");e.array.set(i),e.needsUpdate=!0,Ml.fill(0)}async function Sx(i){const t=(await Ed(()=>import("./GLTFLoader-CPObf4pV.js"),[])).GLTFLoader;new t().load(i,r=>{const s=xx(r.scene,$i);yx(s,vx),Mx(s)},void 0,r=>{console.warn("No se pudo cargar el .glb de particulas, se mantiene la figura de prueba:",r)})}const Iu=new Hn,Uu=new R,Xs=new R,Nu=new R,Ou=new R;function Ex(i,e){if(!tr)return;const t=tr.geometry.getAttribute("position"),n=t.array,r=yl,s=Ml;let o=!1;Qt&&Et===0&&!We()&&(tt.getWorldDirection(Nu),Dn.getWorldPosition(Ou),Iu.setFromNormalAndCoplanarPoint(Nu,Ou),Ki.setFromCamera(bn,tt),Ki.ray.intersectPlane(Iu,Uu)&&(Dn.worldToLocal(Xs.copy(Uu)),o=!0));const a=Math.exp(-6*i),l=To*To;for(let c=0;c<$i;c++){const u=c*3,h=u+1,f=u+2;let m=s[u],_=s[h],g=s[f];if(o){const d=n[u]-Xs.x,p=n[h]-Xs.y,E=n[f]-Xs.z,v=d*d+p*p+E*E;if(v<l&&v>1e-4){const T=Math.sqrt(v),L=d/T,A=p/T,w=E/T,H=1-T/To,M=H*H*i,b=-A,z=L,q=0;m+=(L+b*wo)*Ao*M,_+=(A+z*wo)*Ao*M,g+=(w+q*wo)*Ao*M}}m+=(r[u]-n[u])*Co*i,_+=(r[h]-n[h])*Co*i,g+=(r[f]-n[f])*Co*i,m*=a,_*=a,g*=a,n[u]+=m*i,n[h]+=_*i,n[f]+=g*i,s[u]=m,s[h]=_,s[f]=g}t.needsUpdate=!0,Yr.uniforms.uTime.value=e}const jh=-2.75,$h=2.75,cr=1,bx=1,Ks=.0092,Tx=1.95,Ax=-.55,wx=.68,Cx=.0078,Dn=new Vn;Dn.position.set($h,cr,0);Dn.add(gx());at.add(Dn);Sx(_x);let Zo=cr,Jo=cr;function Kh(){const i=Jt[Mt];return`
    ...
    `,n.style.cursor="pointer";const r=u=>{u.stopPropagation();const h=n.dataset.cat||i.key;dd(h),Ot("open")};n.addEventListener("click",r);const s=n.querySelectorAll(".pc-img"),o=t.projects.map(u=>u.img);let a=1%o.length;const l=setInterval(()=>{const u=n.querySelector(".pc-img.pc-active"),h=u===s[0]?s[1]:s[0];h.src=o[a],requestAnimationFrame(()=>{h.classList.add("pc-active"),u.classList.remove("pc-active")}),a=(a+1)%o.length},Hx),c={catSpec:i,el:n,intervalId:l};return id.push(c),n}function Gx(){const i=Jt[Mt];id.forEach(e=>{const t=e.el.querySelector(".pc-title");t&&(t.innerHTML=`${i[e.catSpec.titleKey]}<span class="pc-sub">${i[e.catSpec.subKey]}</span>`)})}const Vx=3.9,Wx=5.05,Al=new Vn,wa={};kt.forEach(i=>{const e=new Qr({transparent:!0,opacity:0,depthWrite:!1,depthTest:!1}),t=new qe(new es(Vx,Wx),e);t.position.set(i.slot*Aa,1,-42),t.userData={type:"project-card",key:i.key},t.raycast=qe.prototype.raycast,Al.add(t),wa[i.key]=t});at.add(Al);const li={};kt.forEach(i=>{const e=rd(i),t=new rs(e),n=td();t.scale.set(n,n,n),t.position.set(i.slot*Aa,1,-42),_i.add(t),li[i.key]=t});Object.assign(window,{cssCardGroups:li});function Hu(){Object.keys(li).forEach(i=>{try{_i.remove(li[i])}catch{}delete li[i]}),kt.forEach(i=>{const e=rd(i),t=new rs(e),n=td();t.scale.set(n,n,n),t.position.set(i.slot*Aa,1,-42),_i.add(t),li[i.key]=t}),Object.assign(window,{cssCardGroups:li})}function sd(){const i=kt.length,e=ed;kt.forEach((t,n)=>{var f;let r=n-vr;r>i/2&&(r-=i),r<-i/2&&(r+=i);const s=Math.abs(r),o=r*Ux,l=e*(s===0?1:Nx),c=ch.clamp(-r*Ox,-ku,ku);Tl[t.key]=c;const u=(f=window.cssCardGroups)==null?void 0:f[t.key];u&&(u.position.x=o,u.position.z=-42-s*.9,u.scale.set(l,l,l),u.element.classList.toggle("js-hover",s===0));const h=wa[t.key];h&&(h.position.set(o,h.position.y,-42-s*.9),h.rotation.y=c,h.scale.set(l/nr,l/nr,1))})}function jr(){if(We()){sd();return}kt.forEach(e=>{var s;const t=e.slot*Aa;Tl[e.key]=0;const n=(s=window.cssCardGroups)==null?void 0:s[e.key];n&&(n.scale.set(nr,nr,nr),n.position.x=t,n.position.z=-42,n.element.classList.remove("js-hover"));const r=wa[e.key];r&&(r.position.set(t,r.position.y,-42),r.rotation.set(0,0,0),r.scale.set(1,1,1))})}jr();requestAnimationFrame(()=>{jr()});function Xx(i,e){if(We())return;const t=Qt&&Et===2&&!yt;kt.forEach(n=>{var l;const r=(l=window.cssCardGroups)==null?void 0:l[n.key];if(!r)return;const s=r.element;if(!t){s.classList.remove("js-hover");return}const o=s.getBoundingClientRect(),a=o.width>0&&i>=o.left&&i<=o.right&&e>=o.top&&e<=o.bottom;s.classList.toggle("js-hover",a)})}function ad(){kt.forEach(i=>{var t;const e=(t=window.cssCardGroups)==null?void 0:t[i.key];e&&e.element.classList.remove("js-hover")})}const Ht=[{name:"inicio",objectZ:0,offset:7},{name:"perfil",objectZ:Sl,offset:8},{name:"proyectos",objectZ:-42,offset:9},{name:"contacto",objectZ:El,offset:8}],qx=1.4;function ss(i){return i.offset*(We()?qx:1)}function od(){return Ht[0].objectZ+ss(Ht[0])}function ld(){const i=Ht[Ht.length-1];return i.objectZ+ss(i)}let Cn=Ht[0].objectZ+ss(Ht[0]);const cd=.08,ud=200;let Yn=null;const Yx=-42,jx=11,$x=18,Gu=10,Vu=16,Kx=0,Zx=8,Jx=14;function qs(i,e,t,n){const r=Math.abs(i-e);return r<=t?1:r>=n?0:1-(r-t)/(n-t)}const ha=-15,hd=-42,Qx=.0105,ey=3.5,ty=.0088,ny=1.55,Wu=1.05,iy=.42,ry=.2,Xu=3;let yt=!1,$r=null,Nn=0,pn=[],Ro=!1,Kr=!1;const as=new Vn;as.position.set(0,ha,hd);_i.add(as);const sy=3.4,ay=4.6,hr=new Vn;hr.position.set(0,ha,hd);at.add(hr);let Zr=[];function oy(i){Zr.forEach(e=>hr.remove(e)),Zr=i.map((e,t)=>{const n=new Qr({transparent:!0,opacity:0,depthWrite:!1,depthTest:!1}),r=new qe(new es(sy,ay),n);return r.userData={type:"gallery-card",index:t,projectId:e.id},r.raycast=qe.prototype.raycast,hr.add(r),r})}function ly(i,e){const t=document.createElement("div");t.className="gallery-card",t.innerHTML=`
        <div class="gc-inner">
            <img class="gc-img" src="${i.img}" alt="${di(i)}" draggable="false">
        </div>
        <div class="gc-overlay">
            <span class="gc-eyebrow">Proyecto 0${i.id}</span>
            <h3 class="gc-title">${di(i)}</h3>
            <p class="gc-sub">${pl(i)}</p>
        </div>
    `,t.addEventListener("click",r=>{r.stopPropagation(),e===Nn?fl($r,i.id):Mi(e)});const n=new rs(t);return as.add(n),{obj:n,el:t,project:i}}function wl(){const i=We(),e=i?ny:ey,t=i?ty:Qx,n=pn.length;pn.forEach((r,s)=>{let o=s-Nn;o>n/2&&(o-=n),o<-n/2&&(o+=n);const a=Math.abs(o),l=o*e,c=-a*1.5,u=ch.clamp(-o*iy,-Wu,Wu),h=Math.max(.5,1-a*ry);r.obj.position.set(l,0,c),r.obj.rotation.y=u,r.obj.scale.set(t*h,t*h,t*h);const f=Zr[s];f&&(f.position.set(l,0,c),f.rotation.y=u,f.visible=a<=Xu);const m=a<=Xu,_=m?Math.max(0,1-a*.28):0;r.el.style.opacity=_.toFixed(3),r.el.style.pointerEvents=m?"auto":"none",r.el.classList.toggle("gc-center",o===0)})}function cy(i,e){!yt||We()||pn.forEach(t=>{const n=t.el.getBoundingClientRect(),r=n.width>0&&i>=n.left&&i<=n.right&&e>=n.top&&e<=n.bottom;t.el.classList.toggle("js-hover",r)})}function uy(){pn.forEach(i=>i.el.classList.remove("js-hover"))}function Mi(i){const e=pn.length;e!==0&&(Nn=(i%e+e)%e,wl(),Ot("tick"))}window.goToGalleryIndex=Mi;function hy(i){$r=i,Nn=0,pn.forEach(n=>as.remove(n.obj)),pn=vt[i].projects.map((n,r)=>ly(n,r)),oy(vt[i].projects),wl(),yt=!0;const e=document.getElementById("gallery-title"),t=document.getElementById("gallery-hud");e&&(e.innerText=nd(i)),t==null||t.classList.add("active"),os(),xi()}function Cl(){if(!yt)return;yt=!1;const i=document.getElementById("gallery-hud");i==null||i.classList.remove("active"),uy(),pn.forEach(e=>as.remove(e.obj)),pn=[],Zr.forEach(e=>hr.remove(e)),Zr=[],Ot("close"),os(),xi()}window.closeGallery=Cl;const Ys=document.getElementById("gallery-prev"),js=document.getElementById("gallery-next");Ys&&(Ys.addEventListener("click",()=>Mi(Nn-1)),Ys.addEventListener("mouseenter",()=>{Kr=!0}),Ys.addEventListener("mouseleave",()=>{Kr=!1}));js&&(js.addEventListener("click",()=>Mi(Nn+1)),js.addEventListener("mouseenter",()=>{Kr=!0}),js.addEventListener("mouseleave",()=>{Kr=!1}));function dy(i){Ro||Math.abs(i.deltaY)<6||(Ro=!0,Mi(Nn+(i.deltaY>0?1:-1)),setTimeout(()=>{Ro=!1},260))}let Or=null;window.addEventListener("touchstart",i=>{yt&&(Or=i.touches[0].clientX)},{passive:!0});window.addEventListener("touchend",i=>{if(!yt||Or===null)return;const e=i.changedTouches&&i.changedTouches[0]?i.changedTouches[0].clientX:Or,t=Or-e;Or=null,!(Math.abs(t)<=40)&&Mi(Nn+(t>0?1:-1))},{passive:!0});function dd(i){hy(i)}function Ca(i){vr=(i%kt.length+kt.length)%kt.length,sd(),Ot("tick")}window.goToCategoryIndex=Ca;function os(){const i=document.getElementById("cat-switch-nav");if(!i)return;const e=We()&&Qt&&Et===2&&!yt;i.classList.toggle("active",e)}const qu=document.getElementById("cat-prev"),Yu=document.getElementById("cat-next");qu&&qu.addEventListener("click",()=>Ca(vr-1));Yu&&Yu.addEventListener("click",()=>Ca(vr+1));let Fr=null,Br=null;window.addEventListener("touchstart",i=>{!We()||!Qt||Et!==2||yt||i.touches.length===1&&(Fr=i.touches[0].clientX,Br=i.touches[0].clientY)},{passive:!0});window.addEventListener("touchend",i=>{if(Fr===null||Br===null)return;if(!We()||yt||Et!==2){Fr=null,Br=null;return}const e=Fr-i.changedTouches[0].clientX,t=Br-i.changedTouches[0].clientY;Fr=null,Br=null,!(Math.abs(e)<50||Math.abs(e)<Math.abs(t))&&Ca(vr+(e>0?1:-1))},{passive:!0});function fd(i){i=Math.max(0,Math.min(Ht.length-1,i)),yt&&Cl(),Et=i;const e=Ht[i];Cn=e.objectZ+ss(e),i!==2&&ad(),Ot("nav"),Vh(),xi(),os(),We()&&i===2&&(requestAnimationFrame(()=>jr()),setTimeout(()=>jr(),100))}function pd(){let i=0,e=1/0;Ht.forEach((t,n)=>{const r=t.objectZ+ss(t),s=Math.abs(Cn-r);s<e&&(e=s,i=n)}),fd(i)}window.addEventListener("wheel",i=>{if(Qt&&!(He!=null&&He.classList.contains("open"))){if(yt){dy(i);return}Cn+=i.deltaY*cd,Cn=Math.max(ld(),Math.min(od(),Cn)),Yn&&clearTimeout(Yn),Yn=setTimeout(pd,We()?120:ud)}});let Gr=null;const fy=1.2;window.addEventListener("touchstart",i=>{Qt&&(He!=null&&He.classList.contains("open")||(Gr=i.touches[0].clientY))},{passive:!0});window.addEventListener("touchmove",i=>{if(!Qt||Gr===null||He!=null&&He.classList.contains("open")||yt)return;const e=i.touches[0].clientY,t=Gr-e;Gr=e,Cn+=-t*cd*fy,Cn=Math.max(ld(),Math.min(od(),Cn)),Yn&&clearTimeout(Yn),Yn=setTimeout(pd,We()?120:ud)},{passive:!0});window.addEventListener("touchend",()=>{Gr=null});window.jumpToSection=zh=function(i){Qt&&(Yn&&clearTimeout(Yn),fd(i))};let da=0,fa=0;const bn=new Te,Ki=new Tv;window.addEventListener("pointermove",i=>{da=i.clientX/window.innerWidth*2-1,fa=-(i.clientY/window.innerHeight)*2+1,bn.x=da,bn.y=fa,py(i.clientX,i.clientY),Xx(i.clientX,i.clientY),cy(i.clientX,i.clientY)});function py(i,e){if(!In.contact)return;const t=In.contact.element.querySelectorAll(".info-card-links a");if(Et!==3){t.forEach(n=>n.classList.remove("js-hover"));return}t.forEach(n=>{const r=n.getBoundingClientRect(),s=r.width>0&&i>=r.left&&i<=r.right&&e>=r.top&&e<=r.bottom;n.classList.toggle("js-hover",s)})}function my(i){if(Et!==3||i.target.closest&&i.target.closest(".info-card-links"))return!1;const e=In.contact.element.querySelectorAll(".info-card-links a");for(const t of e){const n=t.getBoundingClientRect();if(!(n.width===0||n.height===0)&&i.clientX>=n.left&&i.clientX<=n.right&&i.clientY>=n.top&&i.clientY<=n.bottom){const r=t.getAttribute("href");if(!r)continue;return r.startsWith("mailto:")?window.location.href=r:t.getAttribute("target")==="_blank"?window.open(r,"_blank","noopener"):window.location.href=r,Ot("click"),!0}}return!1}window.addEventListener("click",i=>{if(!Qt)return;if(yt){if(!Nr||i.target!==Nr)return;bn.x=i.clientX/window.innerWidth*2-1,bn.y=-(i.clientY/window.innerHeight)*2+1,Ki.setFromCamera(bn,tt);const t=Ki.intersectObjects([hr],!0);if(t.length>0){let n=t[0].object;for(;n.parent&&!n.userData.type;)n=n.parent;n.userData&&n.userData.type==="gallery-card"&&(n.userData.index===Nn?fl($r,n.userData.projectId):Mi(n.userData.index))}return}if(my(i)||!Nr||i.target!==Nr||Et!==2)return;bn.x=i.clientX/window.innerWidth*2-1,bn.y=-(i.clientY/window.innerHeight)*2+1,Ki.setFromCamera(bn,tt);const e=Ki.intersectObjects([Al],!0);if(e.length>0){let t=e[0].object;for(;t.parent&&!t.userData.type;)t=t.parent;if(t.userData&&t.userData.type==="project-card"){const n=t.userData.key;dd(n),Ot("open")}}});function gy(i){switch(i.type){case"text":return`<div class="case-block case-block-text"><p>${i.body}</p></div>`;case"image":return`<div class="case-block case-block-image"><img src="${i.src}" alt="" loading="lazy" draggable="false"></div>`;case"gif":return`<div class="case-block case-block-image case-block-gif"><span class="case-block-tag">GIF</span><img src="${i.src}" alt="" loading="lazy" draggable="false"></div>`;case"video":return`<div class="case-block case-block-video"><video src="${i.src}"${i.poster?` poster="${i.poster}"`:""} controls autoplay loop muted playsinline preload="metadata"></video></div>`;case"pdf":return`<div class="case-block case-block-pdf"><iframe src="${i.src}#view=FitH" loading="lazy" style="width:100%;height:85vh;border:none;display:block;background:#fff;" title="PDF"></iframe><a href="${i.src}" target="_blank" rel="noopener" style="display:block;text-align:center;margin-top:12px;color:#fff;opacity:0.8;font-size:0.75rem;">Abrir PDF en nueva pestaña</a></div>`;case"embed":return`<div class="case-block case-block-embed"><div style="padding:${i.ratio||"56.25%"} 0 0 0;position:relative;"><iframe src="${i.src}" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media" style="position:absolute;top:0;left:0;width:100%;height:100%;" allowfullscreen loading="lazy" title="Video"></iframe></div><script src="https://player.vimeo.com/api/player.js"><\/script></div>`;case"embed-txt":return`<div class="case-block case-block-embed" data-embed-txt="${(t=>t.replace(/"/g,"&quot;"))(i.src)}"><div style="padding:56.25% 0 0 0;position:relative;"><div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:#0a0a10;color:rgba(255,255,255,0.6);font-size:0.75rem;">Cargando video...</div></div></div>`;case"grid":return`<div class="case-block case-block-grid">${i.images.map(e=>`<img src="${e}" alt="" loading="lazy" draggable="false">`).join("")}</div>`;case"video-row":return`<div class="case-block case-block-video-row">${(i.items||[]).map(e=>e.type==="embed"?`<div class="video-row-item"><div style="padding:${e.ratio||"56.25%"} 0 0 0;position:relative;"><iframe src="${e.src}" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" style="position:absolute;top:0;left:0;width:100%;height:100%;" allowfullscreen loading="lazy"></iframe></div></div>`:e.type==="embed-txt"?`<div class="video-row-item" data-embed-txt="${e.src.replace(/"/g,"&quot;")}"><div style="padding:56.25% 0 0 0;position:relative;"><div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:#0a0a10;color:rgba(255,255,255,0.6);font-size:0.75rem;">Cargando video...</div></div></div>`:e.type==="video"?`<div class="video-row-item"><video src="${e.src}"${e.poster?` poster="${e.poster}"`:""} controls autoplay loop muted playsinline preload="metadata"></video></div>`:e.type==="image"?`<div class="video-row-item"><img src="${e.src}" alt="" loading="lazy"></div>`:"").join("")}</div>`;default:return""}}function _y(i,e){return`<div class="${e&&(e.layout==="tight"||e.name==="Tobey"||i.some(r=>r.type==="grid"||r.type==="video-row"||r.type==="embed-txt"))?"case-blocks case-blocks--tight":"case-blocks"}">${i.map(gy).join("")}</div>`}async function vy(i){const e=i.querySelectorAll("[data-embed-txt]");for(const t of Array.from(e)){const n=t.getAttribute("data-embed-txt");if(n)try{const r=await fetch(n);if(!r.ok)throw new Error(String(r.status));const s=await r.text();t.innerHTML=s,t.querySelectorAll("script").forEach(a=>{const l=document.createElement("script");a.src?l.src=a.src:l.textContent=a.textContent,document.head.appendChild(l)})}catch(r){console.warn("[embed-txt] fallo al cargar",n,r),t.innerHTML=`<div style="padding:16px;background:#1a1a1a;color:#fff;font-size:0.75rem;">No se pudo cargar el video: ${n}</div>`}}}let He=null,cn=null,pa=null;function xy(){cn||(cn=document.createElement("button"),cn.className="lightbox-close",cn.setAttribute("aria-label","Cerrar"),cn.innerHTML='<i class="fa-solid fa-xmark"></i>',cn.addEventListener("click",()=>Ea()),document.body.appendChild(cn))}window.openLightbox=fl=function(i,e){const t=vt[i].projects.find(o=>o.id===e);if(!t)return;He||(He=document.createElement("div"),He.id="lightbox-overlay",He.className="lightbox-overlay",document.body.appendChild(He),He.addEventListener("click",o=>{o.target===He&&Ea()})),xy(),pa=t;const n=t.blocks?_y(t.blocks,t):`<div class="lb-body"><p>${pl(t)}</p></div><div class="lb-gallery">${t.gallery.map(o=>`<img src="${o}" alt="${di(t)}" loading="lazy" draggable="false">`).join("")}</div>`,r=t.layout==="tight"||t.name==="Tobey"||t.blocks&&t.blocks.some(o=>o.type==="grid"||o.type==="video-row"||o.type==="embed-txt"),s=r?"":`
            <div class="lb-hero">
                <img src="${t.img}" alt="${di(t)}" draggable="false">
    ...
    `,vy(He),i==="edicion"&&t.blocks&&t.blocks.length===1&&t.blocks[0].type==="video"?He.classList.add("single-video"):He.classList.remove("single-video"),i==="edicion"&&He.querySelectorAll("video").forEach(a=>{a.addEventListener("play",()=>{if(xt&&!xt.paused){xt.pause(),jo=!0,qt=!1;const l=document.getElementById("master-audio-btn");l&&(l.innerText=Jt[Mt].audio_play)}})}),He.classList.add("open"),cn.classList.add("open"),xi(),Ot("open")};window.closeLightbox=Ea=function(){if(He&&(He.querySelectorAll("video").forEach(i=>{const e=i;e.pause(),e.currentTime=0}),He.querySelectorAll("iframe").forEach(i=>{var e;try{(e=i.contentWindow)==null||e.postMessage('{"method":"pause"}',"*");const t=i.getAttribute("src");t&&t.includes("vimeo")&&i.setAttribute("src",t)}catch{}}),He.classList.remove("open"),He.scrollTop=0),cn&&cn.classList.remove("open"),pa=null,jo&&(jo=!1,xt&&xt.paused)){xt.play().catch(()=>{}),qt=!0;const i=document.getElementById("master-audio-btn");i&&(i.innerText=Jt[Mt].audio_pause)}He==null||He.classList.remove("single-video"),xi(),Ot("close")};window.goToBrandHome=function(){Cl(),Ea(),zh(0)};const Lo=document.getElementById("glow-slider");Lo==null||Lo.addEventListener("input",i=>{document.documentElement.style.setProperty("--card-glow",i.target.value)});window.addEventListener("resize",()=>{tt.aspect=window.innerWidth/window.innerHeight,tt.fov=We()?Xh:Wh,tt.updateProjectionMatrix(),yi.setSize(window.innerWidth,window.innerHeight),mi&&mi.setSize(window.innerWidth,window.innerHeight),Ta.setSize(window.innerWidth,window.innerHeight),Yr&&(Yr.uniforms.uPixelRatio.value=We()?1:Math.min(window.devicePixelRatio,2)),Zh(),jr(),Qh(),yt&&wl(),os(),We()&&ad(),xi(),at.background&&at.background.dispose&&at.background.dispose(),at.background=xl()});const ju=new Fh;function md(){requestAnimationFrame(md);const i=Math.min(ju.getDelta(),1/30),e=ju.getElapsedTime();if(ji&&(ji.rotation.y=e*.006),Qt){const t=We(),n=t?.09:.05;tt.position.z+=(Cn-tt.position.z)*n;const r=yt;if(!bl){const f=r&&Kr;let m=0;f||(m=da*(r?2.2:1.2)*(t?.7:1)),tt.position.x+=(m-tt.position.x)*n;const _=f?0:t||r?.15:.6,g=r?ha:2;tt.position.y+=(g+fa*_-tt.position.y)*n}const s=r?ha:1;tt.lookAt(tt.position.x*.3,s,tt.position.z-8),Dn.rotation.y=e*.35,Ex(i,e),ur.position.y=Jo+Math.sin(e*.5)*.08;const o=qs(tt.position.z,Kx,Zx,Jx);_r.style.opacity=o.toFixed(3),Dn.position.y=Zo+Math.sin(e*.5)*.08,kt.forEach((f,m)=>{var E;const g=(t?.55:1)+Math.sin(e*.6+m*2)*.12,d=(E=window.cssCardGroups)==null?void 0:E[f.key];if(d){d.position.y=g;const v=Tl[f.key]||0;d.rotation.y=v+Math.sin(e*.35+m)*.05}const p=wa[f.key];p&&(p.position.y=g)});const a=yt?0:qs(tt.position.z,Yx,jx,$x);kt.forEach((f,m)=>{var d;const _=(d=window.cssCardGroups)==null?void 0:d[f.key];if(!_)return;let g=a;if(t){const p=kt.length;let E=m-vr;E>p/2&&(E-=p),E<-p/2&&(E+=p),g=a*(E===0?1:Fx)}_.element.style.opacity=g.toFixed(3),_.element.style.pointerEvents=g<.04?"none":"auto"});const l=qs(tt.position.z,Sl,Gu,Vu),c=qs(tt.position.z,El,Gu,Vu);zu("about",l),zu("contact",c);const u=Ht[Et],h=Math.abs(tt.position.z-u.objectZ);bo+=(h-bo)*ix,ua&&(ua.uniforms.focus.value=bo)}mi?mi.render(i):yi.render(at,tt),Ta.render(_i,tt)}md();export{Y0 as $,Ey as A,Nt as B,Ce as C,pv as D,qe as E,Ry as F,Ty as G,Dh as H,by as I,Ay as J,Uh as K,ns as L,wy as M,Ia as N,ot as O,dv as P,vi as Q,No as R,St as S,yy as T,Vn as U,Te as V,Bt as W,ch as X,al as Y,Ph as Z,Cy as _,Sy as a,Qs as a0,ea as a1,aa as a2,Ct as a3,la as a4,oa as a5,ts as a6,Ke as a7,jn as a8,Ma as a9,Kn as aa,Un as ab,My as b,Dy as c,Rn as d,Py as e,Ge as f,R as g,hu as h,Ly as i,Iy as j,W0 as k,Wr as l,af as m,Gl as n,Ft as o,dt as p,Oo as q,rn as r,Ih as s,Zn as t,Z0 as u,Vo as v,Tn as w,Qr as x,$e as y,Gt as z};
